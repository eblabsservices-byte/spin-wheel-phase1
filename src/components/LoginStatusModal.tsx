...
interface LoginStatusModalProps {
  isOpen: boolean
  error?: string | null
  onSuccess: (data: { participantId: string; name: string; phone: string; hasSpun?: boolean }) => void
  hideTerms?: boolean
}

export default function LoginStatusModal(props: LoginStatusModalProps) {
  const { isOpen, error: initialError, onSuccess, hideTerms } = props
